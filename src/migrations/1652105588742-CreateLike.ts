...
export class CreateLike1652105588742 implements MigrationInterface {
  name = 'CreateLike1652105588742'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Comment" ("PK" SERIAL NOT NULL, "CREATE_AT" TIMESTAMP NOT NULL DEFAULT now(), "UPDATE_AT" TIMESTAMP NOT NULL DEFAULT now(), "DELETE_AT" TIMESTAMP, "CONTENT" character varying NOT NULL, "ownerPk" integer, "recipePk" integer, CONSTRAINT "PK_2a73dae0b58d5ba61abdd61da16" PRIMARY KEY ("PK"))`,
    )
    await queryRunner.query(
      `CREATE TABLE "Like" ("PK" SERIAL NOT NULL, "CREATE_AT" TIMESTAMP NOT NULL DEFAULT now(), "UPDATE_AT" TIMESTAMP NOT NULL DEFAULT now(), "DELETE_AT" TIMESTAMP, "ownerPk" integer, "recipePk" integer, CONSTRAINT "PK_cc011c7a5073684f5100e7edbc2" PRIMARY KEY ("PK"))`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Comment" ADD CONSTRAINT "FK_78ddaab16245838eb80c135c285" FOREIGN KEY ("ownerPk") REFERENCES "User"("PK") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "Comment" ADD CONSTRAINT "FK_8019b234c475278714ec59c753c" FOREIGN KEY ("recipePk") REFERENCES "Recipe"("PK") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "Like" ADD CONSTRAINT "FK_f0088f968362f2bb58b2f9e2705" FOREIGN KEY ("ownerPk") REFERENCES "User"("PK") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "Like" ADD CONSTRAINT "FK_9d69872c7ad561707c26e5bf9c1" FOREIGN KEY ("recipePk") REFERENCES "Recipe"("PK") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Like" DROP CONSTRAINT "FK_9d69872c7ad561707c26e5bf9c1"`,
    )
    await queryRunner.query(
      `ALTER TABLE "Like" DROP CONSTRAINT "FK_f0088f968362f2bb58b2f9e2705"`,
    )
    await queryRunner.query(
      `ALTER TABLE "Comment" DROP CONSTRAINT "FK_8019b234c475278714ec59c753c"`,
    )
    await queryRunner.query(
      `ALTER TABLE "Comment" DROP CONSTRAINT "FK_78ddaab16245838eb80c135c285"`,
    )
